...
def buildRoster(schedulelist,db_name):
  ...
  for courseReq in schedulelist:
    requirement=['','',[]]
    querystat="select CRN from course_fall_2016 where subject='"+(str)(courseReq[0])+"' and course='"+(str)(courseReq[1])+"';"
    #print querystat
    db.query(querystat)
    r=db.store_result()
    courseCRNS=[]
    ...
    for courseCRN in courseCRNS:
      labs=1
      #is this a lab?
      labcheck="select credits from course_fall_2016 where CRN='"+(str)(courseCRN)+"';"
      #print labcheck
      db.query(labcheck)
      lab=db.store_result()
      ...
      while 1:
        ...
        quer="select day, start, end from class_fall_2016 where course_CRN='"+(str)(courseCRN)+"';"
        #print quer
        db.query(quer)
        r=db.store_result()
        for row in r.fetch_row(maxrows=0):
        ...
        labquery="select credits,subject from course_fall_2016 where CRN='"+(str)(courseCRN+labs)+"';"
        #print labquery
        db.query(labquery)
        ...
        #print credit_hours
        if not credit_hours:
          labqueryspec="select credits,subject from course_fall_2016 where CRN='"+(str)(courseCRN+labs+1)+"';"
          ...
          if spec_credit_hours[0][0]=="0" and spec_credit_hours[0][1]==courseReq[0]:
            ...
            spec_labclass_quer="select day, start, end from class_fall_2016 where course_CRN='"+(str)(courseCRN+labs+1)+"';"
        ...
        if credit_hours[0][0]=="0" and credit_hours[0][1]==courseReq[0]:
          ...
          #query for classes
          labclass_quer="select day, start, end from class_fall_2016 where course_CRN='"+(str)(courseCRN+labs)+"';"
          #print labclass_quer
